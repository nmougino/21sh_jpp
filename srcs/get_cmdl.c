...
/*   Updated: 2017/06/23 23:15:17 by nmougino         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	new_handle_alt_arrows(t_cmdl *cmdl, char *buf)
{
...
static int	handle_action(t_cmdl *cmdl, char *buf)
{
	if (ft_strequ(buf, K_UP_A) || ft_strequ(buf, K_DO_A)
		...
		return (new_handle_alt_arrows(cmdl, buf));
	return (0);
}
